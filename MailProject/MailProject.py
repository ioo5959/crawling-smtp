...
if __name__ == "__main__": #main함수
    ...
    sender_email = sys.argv[1] #보내는 사람 메일
    app_password = sys.argv[2] #앱 비밀번호


    f = open('emailcontent.txt', 'r')  # 이메일 내용이 있는 텍스트 파일 열기
    ...
    email_lis = pd.read_excel('test.xlsx', usecols=["이메일"]) #메일 주소가 있는 엑셀 파일 접근
